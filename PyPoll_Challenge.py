...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes_county > winning_county_voterturnout) and (vote_percentage_county > winning_county_percentage):
            winning_county_voterturnout = votes_county
